...
class page_25_9105 extends StatefulWidget {

  page_25_9105({super.key,});
  @override
  State<page_25_9105> createState() => _page_25_9105State();
}

class _page_25_9105State extends State<page_25_9105> {
                                ...
                                child: Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Container(
                                        width: 327.w,
                                        child: Text("Создание напоминания",
                                          key: ValueKey("25:9108"),
                                      ...
                                      Container(
                                        width: 327.w,
                                        child: Text("После создания в указанную вами дату и время вам придет уведомление от присложения. Проверьте что у вас включены уведомленияю",
                                          key: ValueKey("25:9109"),
