...
class CustomWidget_25_2087 extends StatelessWidget {
  const CustomWidget_25_2087({super.key});
  ...
  Widget build(BuildContext context) {
    return Positioned(
          ...
          child: SingleChildScrollView(
            ...
            child: Container(
              constraints: BoxConstraints(minWidth: 375.w, minHeight: 712.h),
              child: Column(
                key: ValueKey("25:2087"),
                ...
                children: [
                  SizedBox(
                    ...
                    child: SingleChildScrollView(
                      ...
                      physics: NeverScrollableScrollPhysics(),
                      child: Container(
                        constraints: BoxConstraints(minWidth: 375.w, minHeight: 703.h),
                        padding: EdgeInsets.only(left: 24.w,right: 24.w, top: 24.h,bottom: 24.h),
                        child: Column(
                          key: ValueKey("25:1551"),
                          mainAxisAlignment: MainAxisAlignment.start,
                          crossAxisAlignment: CrossAxisAlignment.start,
                          spacing: 24.h,
                          children: [
